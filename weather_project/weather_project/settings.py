...
Generated by 'djangocms' command using django CMS 5.0.6 and Django 6.0.2.
...
SECRET_KEY = 'django-insecure-4)+q4bm)b_!^3o=(yt90&b&v*fxstjmvpwq2h-wzpvnffmo_*n'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "weather_project", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
